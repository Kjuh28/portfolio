...
export function Abilities(){
    return(
        <section className="p-8 sm:mx-64 mx-auto">
            ...
            <ul className="mx-auto sm:text-7xl text-5xl pt-20 pb-20 md:grid md:grid-rows-2 md:grid-flow-col gap-16 flex flex-wrap sm:justify-between justify-around text-orange_400">
                <li><FaHtml5 /></li>
                <li><FaCss3 /></li>
                <li><FaJs /></li>
                <li><FaReact /></li>
