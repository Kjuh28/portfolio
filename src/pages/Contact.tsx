        ...
        <section id={'contact'} className="p-8 sm:mx-32 mx-auto">
            ...
            <div className="pt-8 pb-8">
                <ul className="text-5xl flex justify-between">
                    <li className="text-orange_400 hover:text-orange_600 hover:scale-110 transition delay-100"><a href="https://www.instagram.com/kerley_sousa_jr/" target="_blank"><FaInstagram/></a></li>
