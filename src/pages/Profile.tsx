        ...
        <section id="profile" className="mx-auto p-8 sm:mx-32">
            <div className="place-items-center sm:my-8 grid lg:flex xl:justify-between text-center lg:text-start">
                <div className="max-w-xl w-full ">
                    ...
                    <footer className="pt-8"><a href="https://drive.google.com/file/d/1YS_iiamWL28lSeF7My1Jwko06hPqEFYi/view?usp=drive_link" download='KerleySousa-curriculo' target="_blank" ><Button txt='Download CV'/> </a></footer>
                </div>
