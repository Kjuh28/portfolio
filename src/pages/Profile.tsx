...
export function Profile(){
    return(
        <section id="profile" className="mx-auto p-8 sm:mx-32">
            <div className="place-items-center sm:my-8 lg:flex lg:justify-between text-center lg:text-start">
                <div className="max-w-xl w-full ">
                    ...
                    <footer className="pt-8"><a href="#"><Button txt='Download CV' /> </a></footer>
                </div>
