        ...
        <section id="profile" className="mx-auto p-8 sm:mx-32">
            <div className="place-items-center sm:my-8 grid lg:flex xl:justify-between text-center lg:text-start">
                <div className="max-w-xl w-full ">
                    ...
                    <footer className="pt-8"><a href="https://drive.google.com/file/d/1MRJ2IRjBi5YT4nQKQ1doUxPTPUu0VrcK/view?usp=sharing" download target="_blank" rel="noopener"><Button tittle='Download CV' /> </a></footer>
                </div>
